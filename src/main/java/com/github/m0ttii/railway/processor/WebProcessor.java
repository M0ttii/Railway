package com.github.m0ttii.railway.processor;

import com.github.m0ttii.railway.eventhandler.EventHandler;
...
public class WebProcessor {
    ...
    public void registerListener(final EventListener listener) {
        ...
        for (final Method method : methods) {
            Railway annotation = method.getAnnotation(Railway.class);
            if (annotation == null)
                continue;
    ...
    private EventHandler createEventHandler(final EventListener listener, final Method method, final Railway annotation) {
